...
export const DEFAULT_CONTENT: CmsContent = {
  ...
  cvDataUrl: null,
  experience: [
    { id: "e1", role: "Research Assistant — LLM AI-Tutor", company: "University of Tübingen · Autonomous Learning Lab", location: "Tübingen", period: "Jul 2026 – Present", bullets: ["LLM-based AI tutor for lectures — conversational agent for student support and adaptive learning."], tags: ["LLMs", "NLP", "Research"], current: true },
    { id: "e2", role: "Research Assistant — Social-Media & Learning", company: "Leibniz-Institut für Wissensmedien (IWM)", location: "Tübingen", period: "Jul 2026 – Present", bullets: ["Social media (TikTok) impact research — studying algorithmic influence on cognition and learning."], tags: ["Research", "Social Media", "Data Science"], current: true },
